...
import { Play, Loader2, CheckCircle2, AlertTriangle, XCircle, Clock } from 'lucide-react'
...
export function SchedulerPage() {
  const { executions, loading, error, isRunning, triggerRun, runError } = useScheduler()
