...
CREATE INDEX "transactions_account_product_date_idx" ON "transactions" USING btree ("account_id","product_id","traded_at");--> statement-breakpoint
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_type_check" CHECK ("type" IN ('buy', 'sell'));